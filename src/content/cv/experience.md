...
DataArt is a global enterprise software development company. I have been working there as a frontend engineer for more than five years and during this time participated in developing a number of products in different spheres, including publishing, musical industry and insurance, and had experience with different tech stacks.

Among other things, I would like to highlight the following ones:
